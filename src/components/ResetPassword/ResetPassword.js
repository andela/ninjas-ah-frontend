...
import * as passwordAction from '../../actions/user/passwordActions';
...
const mapDispatchToProps = dispatch => ({ resetPassword: payload => dispatch(passwordAction.resetPassword(payload)) });
